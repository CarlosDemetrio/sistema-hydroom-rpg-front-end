...
@Component({
  ...
  templateUrl: './presencas-config.component.html'
})
export class PresencasConfigComponent extends BaseConfigComponent<
  PresencaConfig,
...
> {
  ...
  protected buildForm(): FormGroup {
    return this.fb.group({
      ...
      efeito: ['', [Validators.required, Validators.maxLength(200)]],
